...
function EchoNest(apiKey) {
    ...
    this.defaultErrorHandler = function(data) {
        console.log('Unhandled Echo Nest error', data);
    };
}
...
Artist.prototype.genres = function(args, callback, error) {
    this.en.apiRequest('artist/list_genres', args, callback, error);
}
